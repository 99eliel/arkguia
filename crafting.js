...
// O módulo é idempotente: se uma versão antiga deixou botões duplicados, limpa antes de montar.
...
if(!craftTools){craftTools=document.createElement('section');craftTools.className='craftTools';craftTools.innerHTML='<input id="craftSearch" class="field" placeholder="🔎 Buscar item ou material em português..."><select id="craftCategory" class="field"><option value="all">Todas as categorias</option></select>';count.before(craftTools);}
